...
import { Users, MapPin, Calendar, Clock, CheckSquare, CalendarDays, Hash, Award, Info } from "lucide-react"
          ...
          <Card key={group.id} className="hover:shadow-md transition-shadow">
            ...
            <CardContent>
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm text-gray-600 mb-4">
                ...
                {(group as any).days && (
  <div className="flex items-center gap-1">
    <CalendarDays className="h-4 w-4 flex-shrink-0 text-slate-600" />
